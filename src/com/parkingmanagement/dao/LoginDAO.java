...
public class LoginDAO {
    ...
    public List<Login> getAllUsers() {
        String sql = "SELECT * FROM login ORDER BY create_time DESC";
    ...
    public boolean addUser(Login user) {
        String sql = "INSERT INTO login (username, password_hash, email, phone) VALUES (?, ?, ?, ?)";
    ...
    public boolean updateUser(Login user) {
        String sql = "UPDATE login SET password_hash = ?, email = ?, phone = ? WHERE user_id = ?";
